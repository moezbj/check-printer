...
import { FieldPosition } from "../templates";

interface TemplatePreviewRibProps {
...
const TemplatePreview: React.FC<TemplatePreviewRibProps> = ({
  section,
  fields,
  image,
  setImage,
    ...
    if (fields) {
      ...
      formatted.map((e: any) => {
        ...
        if (e.nom === "NUMERO_COMPTE") {
          ...
          setNUMERO_COMPTE(e.nom);
        }
        if (e.nom === "CODE_AGENCE") {
          setCODE_AGENCEX(e.x);
          setCODE_AGENCEY(e.y);
          setCODE_AGENCE(e.nom);
        }
        if (e.nom === "CODE_BANQUE") {
          setCODE_BANQUEX(e.x);
          setCODE_BANQUEY(e.y);
          setCODE_BANQUE(e.nom);
        }
        if (e.nom === "RIB") {
          setRIBX(e.x);
          setRIBY(e.y);
  ...
  const submitStatement = () => {
    ...
    setFields(JSON.stringify(ribArray));
